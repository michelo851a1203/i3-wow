import { defineComponent, ref, computed, provide, watchEffect, h as h$1, Fragment, onMounted, onUnmounted, shallowRef, toRef, watch, useSSRContext, inject, useId, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, Transition, createCommentVNode } from 'vue';
import { l as defu } from '../nitro/nitro.mjs';
import { q, N, E as E$1, n, v, d as d$1 } from './portal-u0Fjoh1P.mjs';
import { o as o$1, u, A, i as i$2, N as N$1, s as s$1, a as o } from './keyboard-Duq8EHr3.mjs';
import { w } from './use-outside-click-Did7lc5E.mjs';
import { s } from './use-resolve-button-type-DOOP2SMg.mjs';
import { f, u as u$1 } from './hidden-Dc_fFmis.mjs';
import { t, i as i$1, l } from './open-closed-BDzQJ33n.mjs';
import { i, E, w as w$1, h, P, N as N$2, T } from './focus-management-vHH7q6nP.mjs';
import { u as useUI, e as arrow } from './tooltip-CpVvyQRR.mjs';
...
let ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(d2, { slots: P2, attrs: s2, expose: h$2 }) {
  ...
  return watchEffect(() => I == null ? void 0 : I(S)), E$1((u$12 = b.value) == null ? void 0 : u$12.defaultView, "focus", (e) => {
    var r, l2;
    e.target !== void 0 && e.target instanceof HTMLElement && t$1.value === 0 && (p() || o$12 && m && (i$22.contains(e.target) || (r = o$1(a.beforePanelSentinel)) != null && r.contains(e.target) || (l2 = o$1(a.afterPanelSentinel)) != null && l2.contains(e.target) || a.closePopover()));
  ...
  var u$2;
  let f$1 = (u$2 = d$1$1.id) != null ? u$2 : `headlessui-popover-button-${i$2()}`, t2 = U("PopoverButton"), o$2 = computed(() => i(t2.button));
  ...
  function p() {
    ...
    if (!e) return;
    function r() {
      u(i$12.value, { [d$1.Forwards]: () => P(e, N$2.First), [d$1.Backwards]: () => P(e, N$2.Last) }) === T.Error && P(E().filter((g) => g.dataset.headlessuiFocusGuard !== "true"), u(i$12.value, { [d$1.Forwards]: N$2.Next, [d$1.Backwards]: N$2.Previous }), { relativeTo: o$1(t2.button) });
    }
    r();
  }
  return () => {
    ...
    return h$1(Fragment, [A({ ourProps: g, theirProps: { ...P$1, ...l2 }, slot: r, attrs: P$1, slots: s$12, name: "PopoverButton" }), e && !b.value && t2.isPortalled.value && h$1(f, { id: a, features: u$1.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: p })]);
  };
} });
...
let je = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: null } }, inheritAttrs: false, setup(d$1$1, { attrs: P$1, slots: s2, expose: h2 }) {
  var w2;
  let f$1 = (w2 = d$1$1.id) != null ? w2 : `headlessui-popover-panel-${i$2()}`, { focus: t2 } = d$1$1, o$2 = U("PopoverPanel"), y = computed(() => i(o$2.panel)), v2 = `headlessui-focus-sentinel-before-${i$2()}`, m = `headlessui-focus-sentinel-after-${i$2()}`;
  ...
  return () => {
    let i2 = { open: o$2.popoverState.value === 0, close: o$2.close }, { focus: p, ...u2 } = d$1$1, e = { ref: o$2.panel, id: f$1, onKeydown: a, onFocusout: t2 && o$2.popoverState.value === 0 ? S : void 0, tabIndex: -1 };
    return A({ ourProps: e, theirProps: { ...P$1, ...u2 }, attrs: P$1, slot: i2, slots: { ...s2, default: (...r) => {
      var l2;
      return [h$1(Fragment, [E$12.value && o$2.isPortalled.value && h$1(f, { id: v2, ref: o$2.beforePanelSentinel, features: u$1.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: I }), (l2 = s2.default) == null ? void 0 : l2.call(s2, ...r), E$12.value && o$2.isPortalled.value && h$1(f, { id: m, ref: o$2.afterPanelSentinel, features: u$1.Focusable, "data-headlessui-focus-guard": true, as: "button", type: "button", onFocus: F })])];
...
//# sourceMappingURL=Popover-Dld3UKTq.mjs.map
