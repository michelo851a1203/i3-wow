import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, createElementBlock, effectScope, readonly, shallowRef, useSSRContext, mergeProps, getCurrentScope, onScopeDispose, useTemplateRef, withCtx, createVNode, createApp, reactive, customRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, toRaw, Text, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, i as baseURL, c as createError$1, j as defuFn, k as klona, l as defu, s as sanitizeStatusCode, m as createDefu, n as getContext, o as createHooks, t as toRouteMatcher, q as createRouter$1, r as parse$1, v as getRequestHeader, w as getRequestHeaders, x as destr, y as isEqual$1, z as setCookie, A as getCookie, B as deleteCookie } from '../nitro/nitro.mjs';
...
import { ssrRenderComponent, ssrRenderTeleport, ssrRenderSuspense, ssrRenderVNode, ssrRenderAttrs } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:fs';
import 'node:path';
...
const _routes = [
  {
    name: "about___zh",
    path: "/zh/about",
    component: () => import('./about-CfYwg--P.mjs')
  },
  {
    name: "about___en",
    path: "/en/about",
  ...
  {
    name: "blog-article-id___zh",
    path: "/zh/blog/article/:id()",
    component: () => import('./_id_-DvWIEt_e.mjs')
  },
  {
    name: "blog-article-id___en",
    path: "/en/blog/article/:id()",
    component: () => import('./_id_-DvWIEt_e.mjs')
  },
  {
    name: "blog___zh",
    path: "/zh/blog",
    component: () => import('./index-CBjKWUFK.mjs')
  },
  {
    name: "blog___en",
    path: "/en/blog",
  ...
  {
    name: "blog-tag-name___zh",
    path: "/zh/blog/tag/:name()",
    component: () => import('./_name_-DgQkvfvG.mjs')
  },
  {
    name: "blog-tag-name___en",
    path: "/en/blog/tag/:name()",
    component: () => import('./_name_-DgQkvfvG.mjs')
  },
  {
    name: "blog-type-type___zh",
    path: "/zh/blog/type/:type()",
    component: () => import('./_type_-BZuuBhZi.mjs')
  },
  {
    name: "blog-type-type___en",
    path: "/en/blog/type/:type()",
    component: () => import('./_type_-BZuuBhZi.mjs')
  },
  {
    name: "cart-checkout___zh",
    path: "/zh/cart/checkout",
    component: () => import('./checkout-q7FtwAmJ.mjs')
  },
  {
  ...
  {
    name: "cart-finished___zh",
    path: "/zh/cart/finished",
    component: () => import('./finished-CMkMimYg.mjs')
  },
  {
    name: "cart-finished___en",
    path: "/en/cart/finished",
    component: () => import('./finished-CMkMimYg.mjs')
  },
  {
    name: "cart___zh",
    path: "/zh/cart",
    component: () => import('./index-DwB-tDg8.mjs')
  },
  {
    name: "cart___en",
    path: "/en/cart",
  ...
  {
    name: "forgotPassword___zh",
    path: "/zh/forgotPassword",
    component: () => import('./forgotPassword-DxRKSBR9.mjs')
  },
  {
  ...
  },
  {
    name: "index___zh",
    path: "/zh",
    component: () => import('./index-abi6QqQO.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "intro___zh",
    path: "/zh/intro",
    component: () => import('./intro-DRdVywpl.mjs')
  },
  {
    name: "intro___en",
    path: "/en/intro",
  ...
  },
  {
    name: "live___zh",
    path: "/zh/live",
    component: () => import('./live-Be0_EyGP.mjs')
  },
  {
    name: "live___en",
    path: "/en/live",
  ...
  {
    name: __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name,
    path: "/zh/member",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./member-I0lM1GH8.mjs'),
    children: [
      {
        name: "member-appointment___zh",
        path: "appointment",
        component: () => import('./appointment-CKhutLYT.mjs')
      },
      {
        name: "member-bePetSitter___zh",
        path: "bePetSitter",
        component: () => import('./bePetSitter-CWwVw7gW.mjs')
      },
      {
        name: "member-collection___zh",
        path: "collection",
        component: () => import('./collection-DuWxB4DF.mjs')
      },
      {
        name: "member___zh",
        path: "",
        component: () => import('./index-K-zNLfxo.mjs')
      },
      {
        name: "member-petSitter-income___zh",
        path: "petSitter/income",
        component: () => import('./income--MWA3ZPr.mjs')
      },
      {
        name: "member-petSitter___zh",
        path: "petSitter",
        component: () => import('./index-C9_yYj91.mjs')
      },
      {
        name: "member-petSitter-orderList___zh",
        path: "petSitter/orderList",
        component: () => import('./orderList-CT0I8N8c.mjs')
      },
      {
        name: "member-petSitter-settings___zh",
        path: "petSitter/settings",
        component: () => import('./settings-Tx_FxBY7.mjs')
      },
      {
        name: "member-wallet___zh",
        path: "wallet",
        component: () => import('./wallet-C3oO5EJy.mjs')
      }
    ]
  },
  {
    ...
    children: [
      {
        name: "member-appointment___en",
        path: "appointment",
        component: () => import('./appointment-CKhutLYT.mjs')
      },
      {
        name: "member-bePetSitter___en",
        path: "bePetSitter",
        component: () => import('./bePetSitter-CWwVw7gW.mjs')
      },
      {
      ...
      {
        name: "member-petSitter-income___en",
        path: "petSitter/income",
        component: () => import('./income--MWA3ZPr.mjs')
      },
      {
        name: "member-petSitter___en",
        path: "petSitter",
        component: () => import('./index-C9_yYj91.mjs')
      },
      {
        name: "member-petSitter-orderList___en",
        path: "petSitter/orderList",
        component: () => import('./orderList-CT0I8N8c.mjs')
      },
      {
        name: "member-petSitter-settings___en",
        path: "petSitter/settings",
        component: () => import('./settings-Tx_FxBY7.mjs')
      },
      {
        name: "member-wallet___en",
        path: "wallet",
        component: () => import('./wallet-C3oO5EJy.mjs')
      }
    ]
  ...
  {
    name: "newPassword___zh",
    path: "/zh/newPassword",
    component: () => import('./newPassword-Dfj7Q22G.mjs')
  },
  {
  ...
  {
    name: "petSitter-id___zh",
    path: "/zh/petSitter/:id()",
    component: () => import('./_id_-B-q8UgEa.mjs')
  },
  {
    name: "petSitter-id___en",
    path: "/en/petSitter/:id()",
    component: () => import('./_id_-B-q8UgEa.mjs')
  },
  {
    name: "petSitters___zh",
    path: "/zh/petSitters",
    component: () => import('./petSitters-Cgfg3Ag6.mjs')
  },
  {
    name: "petSitters___en",
    path: "/en/petSitters",
    component: () => import('./petSitters-Cgfg3Ag6.mjs')
  },
  {
    name: "signIn___zh",
    path: "/zh/signIn",
    component: () => import('./signIn-iiAMgXBj.mjs')
  },
  {
    name: "signIn___en",
    path: "/en/signIn",
  ...
  },
  {
    name: "signUp___zh",
    path: "/zh/signUp",
    component: () => import('./index-DRyxv0xM.mjs')
  },
  {
    name: "signUp___en",
    path: "/en/signUp",
  ...
  {
    name: "signUp-petSitter___zh",
    path: "/zh/signUp/petSitter",
    component: () => import('./petSitter-DrBiGXOj.mjs')
  },
  {
    name: "signUp-petSitter___en",
    path: "/en/signUp/petSitter",
    component: () => import('./petSitter-DrBiGXOj.mjs')
  },
  {
    name: "verifycode___zh",
    path: "/zh/verifycode",
    meta: __nuxt_page_meta || {},
    component: () => import('./verifycode-JM03ILp_.mjs')
  },
  {
    name: "verifycode___en",
    path: "/en/verifycode",
    meta: __nuxt_page_meta || {},
    component: () => import('./verifycode-JM03ILp_.mjs')
  }
...
const namedMiddleware = {
  auth: () => import('./auth-CQuIjoUb.mjs'),
  "verify-code": () => import('./verifyCode-CeTfE34P.mjs')
};
...
const LazyUAccordion = defineAsyncComponent(() => import('./Accordion-D1i5yFVR.mjs').then((r) => r["default"] || r.default || r));
const LazyUAlert = defineAsyncComponent(() => import('./Alert-Cb05HFQT.mjs').then((r) => r["default"] || r.default || r));
const LazyUAvatar = defineAsyncComponent(() => import('./Avatar-DmdANAXU.mjs').then(function(n) {
  return n.A;
}).then((r) => r["default"] || r.default || r));
const LazyUAvatarGroup = defineAsyncComponent(() => import('./AvatarGroup-Dn5y-mwJ.mjs').then((r) => r["default"] || r.default || r));
const LazyUBadge = defineAsyncComponent(() => import('./Badge-CumtTHoY.mjs').then((r) => r["default"] || r.default || r));
const LazyUButton = defineAsyncComponent(() => import('./Button-B_jr3BZp.mjs').then((r) => r["default"] || r.default || r));
const LazyUButtonGroup = defineAsyncComponent(() => import('./ButtonGroup-BKYUUdpd.mjs').then((r) => r["default"] || r.default || r));
const LazyUCarousel = defineAsyncComponent(() => import('./Carousel-D0c_dyFx.mjs').then((r) => r["default"] || r.default || r));
const LazyUChip = defineAsyncComponent(() => import('./Chip-CEx6ZU_l.mjs').then((r) => r["default"] || r.default || r));
const LazyUDropdown = defineAsyncComponent(() => import('./Dropdown-CDH2Sq7k.mjs').then((r) => r["default"] || r.default || r));
const LazyUIcon = defineAsyncComponent(() => import('./Icon-B6ODn5Cd.mjs').then((r) => r["default"] || r.default || r));
const LazyUKbd = defineAsyncComponent(() => import('./Kbd-p8uTVBrN.mjs').then((r) => r["default"] || r.default || r));
const LazyULink = defineAsyncComponent(() => import('./Link-DZ2bKZug.mjs').then((r) => r["default"] || r.default || r));
const LazyUMeter = defineAsyncComponent(() => import('./Meter-DxraM1pX.mjs').then((r) => r["default"] || r.default || r));
const LazyUMeterGroup = defineAsyncComponent(() => import('./MeterGroup-C83rZKq9.mjs').then((r) => r["default"] || r.default || r));
const LazyUProgress = defineAsyncComponent(() => import('./Progress-CPuVGhof.mjs').then((r) => r["default"] || r.default || r));
const LazyUCheckbox = defineAsyncComponent(() => import('./Checkbox-CMJ_xBpd.mjs').then((r) => r["default"] || r.default || r));
const LazyUForm = defineAsyncComponent(() => import('./Form-DWS1SVni.mjs').then((r) => r["default"] || r.default || r));
const LazyUFormGroup = defineAsyncComponent(() => import('./FormGroup-Cf-Rl2v0.mjs').then((r) => r["default"] || r.default || r));
const LazyUInput = defineAsyncComponent(() => import('./Input-CbILM0s7.mjs').then((r) => r["default"] || r.default || r));
const LazyUInputMenu = defineAsyncComponent(() => import('./InputMenu-gnIXLQkd.mjs').then((r) => r["default"] || r.default || r));
const LazyURadio = defineAsyncComponent(() => import('./Radio-DHQFpKts.mjs').then(function(n) {
  return n.R;
}).then((r) => r["default"] || r.default || r));
const LazyURadioGroup = defineAsyncComponent(() => import('./RadioGroup-v-zKL5Ph.mjs').then((r) => r["default"] || r.default || r));
const LazyURange = defineAsyncComponent(() => import('./Range-DCspGnkw.mjs').then((r) => r["default"] || r.default || r));
const LazyUSelect = defineAsyncComponent(() => import('./Select-BFHTlQ-7.mjs').then((r) => r["default"] || r.default || r));
const LazyUSelectMenu = defineAsyncComponent(() => import('./SelectMenu-JtM-AXfn.mjs').then((r) => r["default"] || r.default || r));
const LazyUTextarea = defineAsyncComponent(() => import('./Textarea-BPZ5gSBt.mjs').then((r) => r["default"] || r.default || r));
const LazyUToggle = defineAsyncComponent(() => import('./Toggle-38WUgdkN.mjs').then((r) => r["default"] || r.default || r));
const LazyUTable = defineAsyncComponent(() => import('./Table-CSVDyX6H.mjs').then((r) => r["default"] || r.default || r));
const LazyUCard = defineAsyncComponent(() => import('./Card-qiiMc9gj.mjs').then((r) => r["default"] || r.default || r));
const LazyUContainer = defineAsyncComponent(() => import('./Container-B3qVXset.mjs').then((r) => r["default"] || r.default || r));
const LazyUDivider = defineAsyncComponent(() => import('./Divider-DbDTxGAN.mjs').then((r) => r["default"] || r.default || r));
const LazyUSkeleton = defineAsyncComponent(() => import('./Skeleton-CLT5BHCc.mjs').then((r) => r["default"] || r.default || r));
const LazyUBreadcrumb = defineAsyncComponent(() => import('./Breadcrumb-Et8Aft2a.mjs').then((r) => r["default"] || r.default || r));
const LazyUCommandPalette = defineAsyncComponent(() => import('./CommandPalette-BxB69E0n.mjs').then((r) => r["default"] || r.default || r));
const LazyUCommandPaletteGroup = defineAsyncComponent(() => import('./CommandPaletteGroup-CNujWzIb.mjs').then((r) => r["default"] || r.default || r));
const LazyUHorizontalNavigation = defineAsyncComponent(() => import('./HorizontalNavigation-C7R-R66z.mjs').then((r) => r["default"] || r.default || r));
const LazyUPagination = defineAsyncComponent(() => import('./Pagination-V5D3FNQV.mjs').then((r) => r["default"] || r.default || r));
const LazyUTabs = defineAsyncComponent(() => import('./Tabs-CRJKHp_I.mjs').then((r) => r["default"] || r.default || r));
const LazyUVerticalNavigation = defineAsyncComponent(() => import('./VerticalNavigation-BFmnBl7E.mjs').then((r) => r["default"] || r.default || r));
const LazyUContextMenu = defineAsyncComponent(() => import('./ContextMenu-BS4YsdEP.mjs').then((r) => r["default"] || r.default || r));
const LazyUModal = defineAsyncComponent(() => import('./Modal-CUWDe7J7.mjs').then((r) => r["default"] || r.default || r));
const LazyUModals = defineAsyncComponent(() => Promise.resolve().then(function() {
  return serverPlaceholder;
}).then((r) => r["default"] || r.default || r));
const LazyUNotification = defineAsyncComponent(() => import('./Notification-DbppsVCr.mjs').then((r) => r["default"] || r.default || r));
const LazyUNotifications = defineAsyncComponent(() => import('./Notifications-BhL2J88X.mjs').then((r) => r["default"] || r.default || r));
const LazyUPopover = defineAsyncComponent(() => import('./Popover-Dld3UKTq.mjs').then((r) => r["default"] || r.default || r));
const LazyUSlideover = defineAsyncComponent(() => import('./Slideover-_Y2Rj3tg.mjs').then((r) => r["default"] || r.default || r));
const LazyUSlideovers = defineAsyncComponent(() => Promise.resolve().then(function() {
  return serverPlaceholder;
}).then((r) => r["default"] || r.default || r));
const LazyUTooltip = defineAsyncComponent(() => import('./Tooltip-BpJFnbW6.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./index-Bq1kpYX2.mjs').then((r) => r["default"] || r.default || r));
...
function getCanonicalUrl(common, baseUrl, seo) {
  ...
  const canonicalQueries = isObject$1(seo) && seo.canonicalQueries || [];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-mDVoaqIF.mjs'))
};
...
function definePrivateState(id, privateStateFn, setup) {
...
const useCalendarStore = definePrivateState("useCalendarStore", () => {
  return {
    isShowCalendar: false,
    isCurrentExcludeElement: false,
    position: {
      x: 0,
      y: 0
    },
  ...
  const isPickDateFull = computed(() => {
    return privateState.pickDate.firstDate !== null && privateState.pickDate.secondDate !== null;
  });
  const changeShowCalendarState = (isShow) => {
    privateState.isShowCalendar = isShow;
  };
  const changeCurrentExcludeElement = (isCurrent) => {
    privateState.isCurrentExcludeElement = isCurrent;
  };
  const setPosition = (position) => {
    privateState.position = position;
  };
  ...
  const setCalendarDate = (date) => {
    rematchCalendarDate();
    if (privateState.pickDate.firstDate === null) {
      privateState.pickDate.firstDate = date.setHours(0, 0, 0, 0);
      return;
    }
    privateState.pickDate.secondDate = date.setHours(23, 59, 59, 999);
  };
  const resetPickDate = () => {
    privateState.pickDate.firstDate = null;
    privateState.pickDate.secondDate = null;
  };
  return {
    // getters::
    isShowCalendar: computed(() => privateState.isShowCalendar),
    isCurrentExcludeElement: computed(() => privateState.isCurrentExcludeElement),
    position: computed(() => privateState.position),
    pickDate: computed(() => privateState.pickDate),
    isPickDateFull,
    // methods::
    changeShowCalendarState,
    changeCurrentExcludeElement,
    setPosition,
    setCalendarDate,
    resetPickDate
  };
});
const useCalendar = (initDefaultValue) => {
  const getCalendar = (month, year, previousMonthFn, currentMonthFn, nextMonthFn) => {
    checkIfValidMonth(month);
    checkIfValidYear(year);
    const date = new Date(year, month - 1, 1);
    const currentWeek = fillPreviousMonth(date, month, year, previousMonthFn);
    const [unfinishedCalendar, lastWeek] = fillCurrentMonth(date, month, currentWeek, currentMonthFn);
    const result = fillLastWeek(lastWeek, unfinishedCalendar, nextMonthFn);
    return result;
  };
  const checkIfValidMonth = (month) => {
    if (!Number.isInteger(month))
      throw new ReferenceError("month should be an integer");
    if (month < 1 || month > 12)
      throw new ReferenceError("Month should be between 1 and 12");
  };
  const checkIfValidYear = (year) => {
    if (!Number.isInteger(year))
      throw new ReferenceError("year should be an integer");
    if (year < 0)
      throw new ReferenceError("Month should be between 1 and 12");
  };
  const fillPreviousMonth = (date, month, year, previousMonthFn) => {
    const currentWeek = [];
    const dayOfWeek = date.getDay();
    const prevMonth = new Date(year, month - 1, 0);
    for (let i = 0; i < dayOfWeek; i++) {
      const calendarCustomObject = initDefaultValue(prevMonth.getDate() - i);
      const previousValue = previousMonthFn ? previousMonthFn(calendarCustomObject) : calendarCustomObject;
      currentWeek.unshift(previousValue);
    }
    return currentWeek;
  };
  const fillCurrentMonth = (date, month, currentWeek, currentMonthFn) => {
    const weeks = [];
    let coolWeek = currentWeek;
    while (date.getMonth() === month - 1) {
      const calendarCustomObject = initDefaultValue(date.getDate());
      const currentValue = currentMonthFn ? currentMonthFn(calendarCustomObject) : calendarCustomObject;
      coolWeek.push(currentValue);
      if (date.getDay() === 6) {
        weeks.push(coolWeek);
        coolWeek = [];
      }
    ...
    return [weeks, coolWeek];
  };
  const fillLastWeek = (lastWeek, inputWeeks, nextMonthFn) => {
    if (lastWeek.length > 0) {
      let nextMonthDay = 1;
      while (lastWeek.length < 7) {
        const calendarCustomObject = initDefaultValue(nextMonthDay++);
        const nextValue = nextMonthFn ? nextMonthFn(calendarCustomObject) : calendarCustomObject;
        lastWeek.push(nextValue);
      }
      inputWeeks.push(lastWeek);
    }
    return inputWeeks;
  };
  return {
...
const useDateTimeRanger = (useCalendar2, firstDate, secondDate) => {
  ...
  const firstSelectedYear = computed(() => {
    if (!firstDate.value)
      return -1;
    return firstDate.value.getFullYear();
  });
  const firstSelectedMonth = computed(() => {
    if (!firstDate.value)
      return -1;
    return firstDate.value.getMonth() + 1;
  });
  const firstSelectedDate = computed(() => {
    if (!firstDate.value)
      return -1;
    return firstDate.value.getDate();
  });
  const secondSelectedYear = computed(() => {
    if (!secondDate.value)
      return -1;
    return secondDate.value.getFullYear();
  });
  const secondSelectedMonth = computed(() => {
    if (!secondDate.value)
      return -1;
    return secondDate.value.getMonth() + 1;
  });
  const secondSelectedDate = computed(() => {
    if (!secondDate.value)
      return -1;
    return secondDate.value.getDate();
  });
  const selectedFirstDateFormat = computed(() => firstDate.value ? useDateFormat(firstDate.value, "YYYY-MM-DD").value : "");
  ...
  const triggerCalendarRender = () => {
    return getCalendar(
      ...
      (input) => {
        ...
        if (checkSelectedPreviousActive(input)) {
          input.isActive = true;
        } else {
          if (isInPreviousRange(input.date)) {
            input.isInActiveRange = true;
          }
        }
        input.isBlur = "prev";
        return input;
      ...
      (input) => {
        ...
        if (checkSelectedActive(input)) {
          input.isActive = true;
        } else {
          if (isInRange(input.date)) {
            input.isInActiveRange = true;
          }
        }
        return input;
      ...
      (input) => {
        ...
        if (checkSelectedNextActive(input)) {
          input.isActive = true;
        } else {
          if (isInNextRange(input.date)) {
            input.isInActiveRange = true;
          }
        }
        input.isBlur = "next";
  ...
  const checkSelectedActive = (input) => {
    if (boardShownYear.value === firstSelectedYear.value && boardShownMonth.value === firstSelectedMonth.value && input.date === firstSelectedDate.value) {
      return true;
    }
    if (boardShownYear.value === secondSelectedYear.value && boardShownMonth.value === secondSelectedMonth.value && input.date === secondSelectedDate.value) {
      return true;
    }
    return false;
  };
  const checkSelectedPreviousActive = (input) => {
    let previousBoardShownYear = boardShownYear.value;
    let previousBoardShownMonth = boardShownMonth.value - 1;
    if (previousBoardShownMonth === 0) {
      previousBoardShownYear -= 1;
    }
    previousBoardShownMonth = previousBoardShownMonth === 0 ? 12 : previousBoardShownMonth;
    if (previousBoardShownYear === firstSelectedYear.value && previousBoardShownMonth === firstSelectedMonth.value && input.date === firstSelectedDate.value) {
      return true;
    }
    if (previousBoardShownYear === secondSelectedYear.value && previousBoardShownMonth === secondSelectedMonth.value && input.date === secondSelectedDate.value) {
      return true;
    }
    return false;
  };
  const checkSelectedNextActive = (input) => {
    let nextBoardShownYear = boardShownYear.value;
    let nextBoardShownMonth = boardShownMonth.value + 1;
    if (nextBoardShownMonth === 13) {
      nextBoardShownYear += 1;
    }
    nextBoardShownMonth = nextBoardShownMonth === 13 ? 1 : nextBoardShownMonth;
    if (nextBoardShownYear === firstSelectedYear.value && nextBoardShownMonth === firstSelectedMonth.value && input.date === firstSelectedDate.value) {
      return true;
    }
    if (nextBoardShownYear === secondSelectedYear.value && nextBoardShownMonth === secondSelectedMonth.value && input.date === secondSelectedDate.value) {
      return true;
    }
    return false;
  };
  const isInRange = (inputDate) => {
    const first = firstDate.value;
    const second = secondDate.value;
    if (first === null || second === null)
      return false;
    const input = new Date(boardShownYear.value, boardShownMonth.value - 1, inputDate).setHours(0, 0, 0, 0);
    const firstTimeStamp = first.getTime();
    const secondTimeStamp = second.getTime();
    if (firstTimeStamp <= secondTimeStamp) {
      return input > firstTimeStamp && input < secondTimeStamp;
    }
    return input < firstTimeStamp && input > secondTimeStamp;
  };
  const isInPreviousRange = (inputDate) => {
    const first = firstDate.value;
    const second = secondDate.value;
    if (first === null || second === null)
      return false;
    const input = new Date(boardShownYear.value, boardShownMonth.value - 2, inputDate).setHours(0, 0, 0, 0);
    const firstTimeStamp = first.getTime();
    const secondTimeStamp = second.getTime();
    if (firstTimeStamp <= secondTimeStamp) {
      return input > firstTimeStamp && input < secondTimeStamp;
  ...
  const isInNextRange = (inputDate) => {
    const first = firstDate.value;
    const second = secondDate.value;
    if (first === null || second === null)
      return false;
    const input = new Date(boardShownYear.value, boardShownMonth.value, inputDate).setHours(0, 0, 0, 0);
    const firstTimeStamp = first.getTime();
    const secondTimeStamp = second.getTime();
    if (firstTimeStamp <= secondTimeStamp) {
      return input > firstTimeStamp && input < secondTimeStamp;
  ...
  const refreshActiveCurrentCalendar = (currentDate, isBlurSection) => {
    const processCount = 2;
    const newCalendar = [...calendar.value];
    for (const weekDateList of newCalendar) {
      for (const item of weekDateList) {
        const [newItem, newProcessCount] = handleRefreshActive(item, currentDate, isBlurSection, processCount);
  ...
  const handleRefreshActive = (item, currentDate, isBlurSection, processCount = 2) => {
    if (item.isActive === true) {
      delete item.isActive;
      return [item, --processCount];
    }
    if (item.isBlur === isBlurSection && item.date === currentDate) {
      item.isActive = true;
      return [item, --processCount];
    }
    return [item, processCount];
  };
  const setCurrentDateActive = (currentDate, isBlurSection) => {
    if (firstDate.value === null) {
      setFirstDateActive(currentDate, isBlurSection);
      return;
    }
    setSecondDateActive(currentDate, isBlurSection);
  };
  const setFirstDateActive = (currentDate, isBlurSection) => {
    const monthIndex = boardShownMonth.value - 1;
    if (!isBlurSection) {
      firstDate.value = new Date(boardShownYear.value, monthIndex, currentDate);
      refreshActiveCurrentCalendar(currentDate, isBlurSection);
      return;
    }
    if (isBlurSection === "prev") {
      firstDate.value = new Date(boardShownYear.value, monthIndex - 1, currentDate);
    }
    if (isBlurSection === "next") {
      firstDate.value = new Date(boardShownYear.value, monthIndex + 1, currentDate);
    }
    refreshActiveCurrentCalendar(currentDate, isBlurSection);
  };
  const setSecondDateActive = (currentDate, isBlurSection) => {
    const monthIndex = boardShownMonth.value - 1;
    if (!isBlurSection) {
      secondDate.value = new Date(boardShownYear.value, monthIndex, currentDate);
      refreshActiveCurrentCalendar(currentDate, isBlurSection);
      return;
    }
    if (isBlurSection === "prev") {
      secondDate.value = new Date(boardShownYear.value, monthIndex - 1, currentDate);
    }
    if (isBlurSection === "next") {
      secondDate.value = new Date(boardShownYear.value, monthIndex + 1, currentDate);
    }
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { changeShowCalendarState, setCalendarDate } = calendarStore;
    const { isShowCalendar, isCurrentExcludeElement, position, pickDate } = storeToRefs(calendarStore);
    const firstDate = computed({
      get: () => {
        const currentDate = pickDate.value.firstDate;
        if (currentDate === null)
          return null;
    ...
    const secondDate = computed({
      get: () => {
        const currentDate = pickDate.value.secondDate;
        if (currentDate === null)
          return null;
        return new Date(currentDate);
      },
    ...
    watch(isShowCalendar, (isCalendarCurrentShow) => {
      if (isCalendarCurrentShow) {
        const first = firstDate.value;
        if (first === null) {
          setControlBoardNow();
        } else {
          setBoardShownYearButNotRefresh(first.getFullYear());
          setBoardShownMonthButNotRefresh(first.getMonth() + 1);
        }
      }
      refreshCalendar();
    });
    watch([firstDate, secondDate], ([first, second]) => {
      if (first !== null && second === null) {
        refreshCalendar();
      }
    });
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(_attrs)}>error page</div>`);
}
...
export { omit as A, useRouter as B, parseQuery as C, nuxtLinkDefaults as D, resolveRouteObject as E, withTrailingSlash as F, withoutTrailingSlash as G, useFileDialog as H, useCounter as I, __nuxt_component_0 as J, useDateTimeRanger as K, useCalendar as L, onClickOutside as M, createSharedComposable as N, useWindowScroll as O, useNow as P, useWindowSize as Q, useParentElement as R, useMouse as S, useDebounceFn as T, defineNuxtRouteMiddleware as U, getSlotsChildren as V, looseToNumber as W, useState as X, _export_sfc as _, useLocalePath as a, useThrottleFn as b, useCalendarStore as c, useElementBounding as d, entry$1 as default, useI18n as e, useHead as f, useRoute as g, __nuxt_component_1 as h, definePrivateState as i, useRequestEvent as j, hasProtocol as k, joinURL as l, encodeParam as m, navigateTo as n, encodePath as o, parseURL as p, useNuxtApp as q, useRuntimeConfig as r, asyncDataDefaults as s, createError as t, useDateFormat as u, useAppConfig as v, withLeadingSlash as w, mergeConfig as x, appConfig as y, get as z };
