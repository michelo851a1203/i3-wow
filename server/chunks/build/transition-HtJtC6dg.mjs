...
import { n, E as E$1, q, N as N$2, u as u$3, $ as $$1, z as z$1, d as d$1$1 } from './portal-u0Fjoh1P.mjs';
import { f, u as u$1 } from './hidden-Dc_fFmis.mjs';
import { t as t$3, o as o$2 } from './active-element-history-Cer4cSOw.mjs';
import { A as A$2, o as o$1, i as i$2, u as u$2, a as o, N as N$3, S as S$1, T as T$1 } from './keyboard-Duq8EHr3.mjs';
import { i as i$1, S, c as c$1, P, N as N$4, T as T$2 } from './focus-management-vHH7q6nP.mjs';
import { t as t$1 } from './micro-task-B6uncIso.mjs';
import { w as w$1, t as t$4 } from './use-outside-click-Did7lc5E.mjs';
import { l as l$2, i as i$3, s as s$1, t as t$2 } from './open-closed-BDzQJ33n.mjs';
import { k } from './description-BDgAPIdI.mjs';
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$1, slots: r, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$1(T2, d2) || (s2.value ? P(o$1(o$12), u$2(f$1.value, { [d$1$1.Forwards]: () => N$4.Next, [d$1$1.Backwards]: () => N$4.Previous }) | N$4.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
...
let W = N$3.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t2, attrs: a2, slots: s2, expose: h$1 }) {
  ...
  h$1({ el: d2, $el: d2 });
  let { show: v, appear: A2 } = Te(), { register: D, unregister: H2 } = ge(), i2 = ref(v.value ? "visible" : "hidden"), I = { value: true }, c2 = i$2(), b = { value: false }, P2 = Q(() => {
  ...
  }), provide(N, P2), t$2(computed(() => u$2(i2.value, { ["visible"]: i$3.Open, ["hidden"]: i$3.Closed }) | n2.value)), () => {
  ...
  let h$1 = l$2(), n2 = computed(() => e.show === null && h$1 !== null ? (h$1.value & i$3.Open) === i$3.Open : e.show);
  watchEffect(() => {
...
//# sourceMappingURL=transition-HtJtC6dg.mjs.map
