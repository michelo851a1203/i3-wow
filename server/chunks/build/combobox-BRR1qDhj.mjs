...
import { o as o$2, t as t$2 } from './active-element-history-Cer4cSOw.mjs';
import { o as o$1, u, E, A, T, i as i$2, N, a as o } from './keyboard-Duq8EHr3.mjs';
import { w, n } from './use-outside-click-Did7lc5E.mjs';
import { s } from './use-resolve-button-type-DOOP2SMg.mjs';
import { c, f, i as i$4, u as u$1$1 } from './calculate-active-index-Dujs8zvP.mjs';
import { f as f$1, u as u$1 } from './hidden-Dc_fFmis.mjs';
import { t as t$1, i as i$1, l } from './open-closed-BDzQJ33n.mjs';
import { i as i$3, O } from './focus-management-vHH7q6nP.mjs';
...
defineComponent({ name: "ComboboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r }) {
  var e2;
  let y = (e2 = a.id) != null ? e2 : `headlessui-combobox-label-${i$2()}`, o2 = K("ComboboxLabel");
  function u2() {
    var c2;
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r, expose: y }) {
  var S;
  let o2 = (S = a.id) != null ? S : `headlessui-combobox-button-${i$2()}`, u2 = K("ComboboxButton");
...
//# sourceMappingURL=combobox-BRR1qDhj.mjs.map
