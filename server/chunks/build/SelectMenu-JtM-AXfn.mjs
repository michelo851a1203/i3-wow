...
import { f, c, u as u$1$1 } from './calculate-active-index-Dujs8zvP.mjs';
import { f as f$1, u as u$1 } from './hidden-Dc_fFmis.mjs';
import { t, i, l } from './open-closed-BDzQJ33n.mjs';
import { w as w$1, h, O } from './focus-management-vHH7q6nP.mjs';
import { c as computedAsync } from './index-BWxBLvh9.mjs';
import { l as defu } from '../nitro/nitro.mjs';
import { twMerge, twJoin } from 'tailwind-merge';
import { s as select, a as selectMenu, u as useUI } from './tooltip-CpVvyQRR.mjs';
...
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o$2, { attrs: b, slots: r, expose: w2 }) {
  var p2;
  let n = (p2 = o$2.id) != null ? p2 : `headlessui-listbox-button-${i$1()}`, e2 = A("ListboxButton");
  ...
  var p2;
  let n = (p2 = o$2.id) != null ? p2 : `headlessui-listbox-options-${i$1()}`, e2 = A("ListboxOptions"), f2 = ref(null);
...
//# sourceMappingURL=SelectMenu-JtM-AXfn.mjs.map
